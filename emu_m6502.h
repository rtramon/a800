...
typedef struct m6502 {
  // uint8_t (*read_byte)(void *, uint16_t); // user function to read from
  // memory void (*write_byte)(void *, uint16_t, uint8_t); // same for writing
  // to memory void *userdata;                                // user custom
  // pointer
