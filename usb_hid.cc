...
void
process_generic_report(uint8_t dev_addr,
                       uint8_t instance,
...
void
tuh_hid_mount_cb(uint8_t dev_addr,
                 uint8_t instance,
...
void
tuh_hid_report_received_cb(uint8_t dev_addr,
                           uint8_t instance,
                           uint8_t const* report,
                           uint16_t len)
{
...
static inline bool
is_key_pressed(hid_keyboard_report_t const* report)
{
  for (int i = 0; i < 6; i++)
...
static inline bool
is_key_held(hid_keyboard_report_t const* report, uint8_t keycode)
{
